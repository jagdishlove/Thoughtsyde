...
import { ArrowRight, Sparkles, MessageSquare, Zap, BarChart3 } from "lucide-react";
...
const Hero = () => {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-purple-200/20 rounded-full blur-3xl -z-10 animate-float" style={{ animationDelay: '2s' }} />
      ...
      <div className="container mx-auto px-4 py-20 lg:py-32">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 max-w-2xl text-center lg:text-left animate-fade-in-up">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Easily integrate our widget and start collecting valuable feedback from your users today. 
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <SignedOut>
                <SignUpButton>
                  <Button size="lg" className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-6 text-lg rounded-xl 
              ...
              <SignedIn>
                <Button asChild size="lg" className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-6 text-lg rounded-xl 
                                              shadow-lg shadow-indigo-200 hover:shadow-xl hover:shadow-indigo-300
                                              transition-all duration-300 hover:-translate-y-1">
                  <Link href="/dashboard">
                    Go to Dashboard
            ...
            {/* Trust badges */}
            <div className="mt-12 pt-8 border-t border-gray-200 animate-fade-in" style={{ animationDelay: '0.6s' }}>
          ...
          {/* Image/Demo */}
          <div className="flex-1 max-w-xl w-full animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            <div className="relative group">
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200 
                            hover:shadow-3xl transition-shadow duration-500 hover:scale-[1.02] transform">
                <Image 
                  src={'/demo.gif'} 
