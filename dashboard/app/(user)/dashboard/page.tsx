            ...
            <p className="text-gray-600 mt-1">
              {isFreeUser ? (
                <span className="flex items-center gap-2">
                  <span className="badge-smooth bg-gray-100 text-gray-700">Free Plan</span>
                  <span className="text-sm">{currentCount} of {maxFreeProjects} projects used</span>
                </span>
              ) : (
                <span className="flex items-center gap-2">
        ...
        <Card className="mb-6 bg-yellow-50/80 border-yellow-200 hover-lift">
          <CardHeader className="pb-3">
            ...
            <CardDescription className="text-yellow-700">
              You have {maxFreeProjects - currentCount} project{maxFreeProjects - currentCount === 1 ? '' : 's'} remaining. 
              <Link href="/payments" className="font-medium underline ml-1 link-smooth text-yellow-800">
                Upgrade to Premium
        ...
        <Card className="mb-6 bg-gradient-to-r from-gray-50 to-gray-100 border-gray-200 hover-lift">
          <CardContent className="pt-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <Link href="/payments">
                <Button size="lg" className="btn-primary bg-gradient-to-r from-indigo-600 to-purple-600">
