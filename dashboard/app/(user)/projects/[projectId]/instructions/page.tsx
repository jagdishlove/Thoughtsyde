...
import { ArrowLeft, Globe, Code, FileCode, AlertCircle, CheckCircle } from "lucide-react";
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <span>/</span>
          <Link href={`/projects/${params.projectId}`} className="hover:text-indigo-600">
            Project
          </Link>
          <span>/</span>
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Copy and paste this code where you want the feedback button to appear on your site
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="bg-slate-900 p-4 rounded-lg relative group">
...
<body>
  ...
  ${scriptCode}
        ...
        <Alert className="bg-yellow-50 border-yellow-200">
          ...
          <AlertDescription className="text-yellow-700">
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>The widget works with any website - React, Vue, vanilla HTML, etc.</li>
      ...
      <div className="mt-8 flex flex-col sm:flex-row gap-4">
        <Link href={`/projects/${params.projectId}`} className="flex-1">
